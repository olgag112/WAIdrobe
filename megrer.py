...
# Wczytaj dane
rec_df = pd.read_csv("recommendations_output.csv")  # np. z kolumnami user_id, temperature, ..., top_id, top_name, bottom_id, bottom_name, score
wardrobe_df = pd.read_csv("synthetic_wardrobe.csv")    # szczegóły ubrań
