...
def main():
    ...
    parser.add_argument("--input", type=str, default="/Users/olgagranecka/Downloads/synthetic_wardrobe.csv",
    ...
    print(recommendations[['item_id', 'type', 'special_property', 'rule_score', 'content_score', 'score', 'color_feedback']])
